...
Vi starter med å se på noen tabeller som inneholder tallgrunnlag for å gjennomføre denne analysen. I tabell 2 ser vi at en elbilist har en kostnad på 1,98 kroner per kilometer inkl. alle avgifter, og i tabell 3 ser vi at forbrenningsmotoren har en kostnad på 3,03 kroner per kilometer.
...
I tabell 4 og 5 finner vi taksten og tallgrunnlaget for bilister under 3,5 tonn. Og i [denne](https://www.nordlys.no/bompenge-snittet-okte-i-mars-de-viktigste-tallene-gar-ned/s/5-34-1776123) artikkelen fra Nordlys får vi videre vite at gjennomsnittlig bompengeregning er på rundt 350 kroner hver måned i Tromsø som omgjort til årlig blir 4200 kroner.
...
Median årlig inntekt i Tromsø finner man på SSB [her.](https://www.ssb.no/97014/median-inntekt-etter-skatt-etter-fylke-og-husholdningstype.kroner) Denne sier at medianinntekten er på 422 000 kroner for Tromsø i 2022.
...
p1 = 1.98
p2 = 1
x1_range = np.linspace(0, 442000, 100)
...
# Setter x-lim og y-limit
ax.set_xlim(0, 442000)
...
Gamma er minimumskonsumet av gode 1 og 2. Her Vi setter $\gamma_1$ til 1 og $\gamma_2$ til 0.5 siden blabla.
...
x_1_eq_num = float(x_1_eq.subs([(bta_1, beta_1), (gma_1, 1), (gma_2, 1), (m, M), (p_1, p1), (p_2, p2)]))
x_2_eq_num = float(x_2_eq.subs([(bta_2, beta_2), (gma_1, 1), (gma_2, 1), (m, M), (p_1, p1), (p_2, p2)]))
nytte_sg_num = float(like_v.subs([(bta_1, beta_1),(bta_2, beta_2), (gma_1, 1), (gma_2, 1), (m, M), (p_1, p1), (p_2, p2)]))
```

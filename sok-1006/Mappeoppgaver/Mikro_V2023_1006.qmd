...
I denne utredningen skal vi fokusere på turistnæringen i Nord-Norge. Nord-Norge består av fylkene Nordland og Troms og Finnmark. For å forstå viktigheten av dette markedet skal vi gå gjennom noen sentrale tall og figurer for å se hvordan de Nord-Norske turistnæringene har hatt det de siste årene.
...
Når vi ser på økonomien til hotellene i Nord-Norge, har det vært en liten økning de siste årene. I 2016 lå gjennomsnittsprisen på hotellrom på 858 kroner, mens i 2022 har prisen økt til 1054 kroner. Dette betyr en økning på 22,8 prosent i gjennomsnittlig årlig hotellromspris over denne perioden.
...
Ser man på prisene månedlig så varierer prisene veldig til hvilken måned det er og man klarer ikke se noen årsakssammenheng som at overnattinger blir dyrere i høysesongen. Dette kan være en svakhet med å se på gjennomsnittshotellprisene for fylker, ettersom hvis vi ser på turistplasser som Lofoten kan det avvike noe fra denne fremstillingen. Den dyreste måneden vi klarer å finne her var desember 2022 hvor gjennomsnittsprisen for et hotellrom lå på litt over 1400 kroner per natt i troms og finnmark.
...
Her ser vi PP blir nye produsentpris etter skatt og P2 blir nye konsumentpris etter skatt. Med dette skjer to ting.

Det første er at vi i det stiplede området mellom PP som betyr produsentpris og P2 blir skatteprovenyen. Altså inntektene som genereres av den innførte skatten. Dette området er markert i blått.

Det andre som blir å skje er at det blir en kile mellom konsumentpris og produsentpris. Dette er dødvektstapet som produsenten og konsumenten mister når skatten blir innført. Dette er det samfunnsøkonomiske tapet som skjer når skatten blir innført og er markert i grått.
...
For å finne ut hvor stor etterspørselen er må vi summere over alle  konsumentene i markedet, for å konkretisere dette så setter vi alle konsumenter som summen av alle hotellovernattinger med formål å besøke Nord-Norge for å dra på ferie. I denne oppgaven blir det for omfattende å gjøre denne analysen, men det finnes en tidligere masteroppgave som har funnet noen tall på priselastisiteten for å reise til Norge.

I masteroppgaven sin skriver Engebretsen(2017) at hun fant en valutakurselastisitet på 1.24 og en priselastisitet for relativt prisnivå på -2.79. Disse estimatene betyr at etterspørselen etter overnattinger er elastisk, det vil si at en 1% økning i pris vil gi en nedgang på 2,79% i etterspørselen etter overnattinger i Norge.

I masteroppgaven sin skriver også Engebretsen (2017) at dersom den norske kronen depresierer, så vil etterspørselen øke, og dersom det blir relativt dyrere i Norge vil etterspørselen falle. 
...
Med innføring av turistskatt i Nord-Norge er det hovedsakelig ment for at etterspørselen skal bli lavere til utsatte områder i landsdelen preget av overturisme. Hovedformålet  for dette er at det vil føre til at det blir mindre bruk og miljøbelastning og at en del av skatten kan brukes til å vedlikeholde viktig infrastruktur.
